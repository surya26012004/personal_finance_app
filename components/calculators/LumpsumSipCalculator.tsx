...
import { calculateLumpsumSip } from '../../utils/calculator';
import type { LumpsumSipInput, SipResult } from '../../types';
import InputSlider from '../ui/InputSlider';
import AnimatedCounter from '../ui/AnimatedCounter';
import ResultChart from '../ui/ResultChart';
import { Card } from '../ui/Card';

const LumpsumSipCalculator: React.FC = () => {
    const [input, setInput] = useLocalStorage<LumpsumSipInput>('lumpsum-sip-input', {
        lumpsum: 100000,
    ...
    const result: SipResult = useMemo(() => calculateLumpsumSip(input), [input]);

    const handleInputChange = (field: keyof LumpsumSipInput) => (value: number) => {
    ...
    return (
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 items-start">
            <Card className="animate-fade-in">
                <h3 className="text-xl font-semibold mb-6">Lumpsum + Step-up SIP</h3>
                <div className="space-y-6">
                    ...
                    />
                     <InputSlider
                        ...
                        value={input.annualIncrease}
                        onChange={handleInputChange('annualIncrease')}
                        min={0}
                        max={25}
                        step={1}
                        unit="%"
                ...
                <Card>
                    <div className="space-y-4">
                        ...
                        <div className="flex justify-between text-sm">
                            <span className="text-text-secondary-light dark:text-text-secondary-dark">Total Invested Amount</span>
