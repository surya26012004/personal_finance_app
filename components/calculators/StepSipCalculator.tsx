...
import { calculateStepSip } from '../../utils/calculator';
import type { StepSipInput, SipResult } from '../../types';
import InputSlider from '../ui/InputSlider';
import AnimatedCounter from '../ui/AnimatedCounter';
import ResultChart from '../ui/ResultChart';
import { Card } from '../ui/Card';

const StepSipCalculator: React.FC = () => {
    const [input, setInput] = useLocalStorage<StepSipInput>('step-sip-input', {
    ...
    const result: SipResult = useMemo(() => calculateStepSip(input), [input]);

    const handleInputChange = (field: keyof StepSipInput) => (value: number) => {
    ...
    return (
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 items-start">
            <Card className="animate-fade-in">
                <h3 className="text-xl font-semibold mb-6">Step-up SIP Details</h3>
...
export default StepSipCalculator;
